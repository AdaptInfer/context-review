...
giving a systematic procedure for estimating a shared coefficient vector $\beta$ from $n$ i.i.d. observations, each pairing a covariate vector $x_i$ with an outcome $y_i$. Generalized linear models (GLMs) extended this reach to non-Gaussian outcomes. Nelder and Wedderburn connected the mean of the response to a linear predictor through a link function [@doi:10.2307/2344614], later formalized into the now-standard compact notation [@doi:10.1007/978-1-4899-3242-6],
