...
3. [Evolution of Statistical Modeling](content/03.historical.md)
4. [Explicit Adaptivity: Structured Estimation of $f(c)$](content/04.explicit.md)
5. [Implicit Adaptivity: Emergent Contextualization within Complex Models](content/05.implicit.md)
6. [Theoretical Bridges Between Varying-Coefficient Models and In-Context Learning](content/06.bridge.md)
7. [Principles of Context-Adaptive Inference](content/07.principles.md)
8. [Evaluation and Design Principles for Context-Adaptive Inference](content/08.evaluation.md)
9. [Making Implicit Adaptivity Explicit: Local Models, Surrogates and Post Hoc Approximations](content/09.interpretation.md)
